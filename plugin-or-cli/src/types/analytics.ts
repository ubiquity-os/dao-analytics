...
export type IssueAnalytics = {
  ...
  reviewerAnalytics: ReviewerStats[] | null;
  commitAnalytics: CommitAnalytics | null;
  issueSentimentScore: number;
  prSentimentScore: number;
  issue: RestEndpointMethodTypes["issues"]["get"]["response"]["data"] | null | undefined;
  pullRequest: RestEndpointMethodTypes["pulls"]["get"]["response"]["data"] | null | undefined;
};
...
export type PullRequestAnalytics = {
   ...
   */
  timeFromOpenToMerge: number | null;
  /**
